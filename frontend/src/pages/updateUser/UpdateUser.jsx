    ...
    <div className="container mt-4 mb-4">
      ...
      <form className="mt-4">
        <div className="mb-4 check">
          <input
            className="form-check-input my-check-tag"
            type="checkbox"
            ...
            id="flexCheckDefault"
          />
          <label className="form-check-label label_level_1">Admin</label>
        </div>
        <div className="mb-4">
        ...
        <div className="lavel_2">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="form-control my-input-tag"
              ref={detailEle}
              onChange={handladdressdetail}
              id="addressdetail"
              name="address.addressdetail"
              defaultValue={user.address?.addressdetail}
            />
          </div>
        </div>

        <Link className="btn btn-primary my-bnt bnt-back" to="/admin/customers">
          Quay lại
        </Link>
