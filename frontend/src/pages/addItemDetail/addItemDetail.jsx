          ...
          <div className="row">
            ...
            <div className="col">
              <a
                ...
                onClick={(e) => handleUpload(c)}
              >
                Tải lên
              </a>
            </div>
          </div>
          <p className="text-danger thongbaoloi" id={'imageError' + num}>
  ...
  return item ? (
    <div className="container">
      ...
      <form id="createOptioninfo">
        ...
        <h5>Bộ nhớ</h5>
        <select
          className="form-select form-select-lg mb-3 textareafont"
          value={type}
          name="detail"
          id="type"
        ...
        {option1}
        <div className="stage">
          <button className="btnoption" onClick={Createoption} type="button">
            Thêm option
          </button>
        </div>
        <button
          className="btn-primary btn-lg form-control custombtn"
          id="newoption"
          type="button"
